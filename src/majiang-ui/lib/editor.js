...
module.exports = class PaipuEditor {
        ...
        for (let i = 0; i < log.length; i++) {
            ...
            if (data.qipai) {
                ...
                $('.result', paipu).eq(hule.l)
                    .off('click').on('click',
                            ()=>this.open_hule_dialog(
                                        this.make_hule(hule.l, null, 1)));
            }
            else if (data.pingju) {
    ...
    make_hule(l, fubaopai, exist) {
        ...
        function seek_log(l, log, param) {
            ...
            for (let data of log) {
                if (data.qipai) {
                    ...
                    if (data.hule.l == l && exist) return data;
                    param.changbang = 0;
                    param.lizhibang = 0;
                    continue;
                }
        ...
        param.fubaopai = fubaopai || param.lizhi && model.shan.fubaopai;
    ...
    init_hule_dialog() {
        ...
        $('[name="fubaopai"]', form).off('change').on('change', ()=>{
            ...
            this.draw_hule_dialog(this.make_hule(+l, fubaopai));
        });
